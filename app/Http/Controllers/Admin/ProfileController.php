...
class ProfileController extends Controller
{
    ...
    public function update_password(Request $request)
    {
        ...
        return redirect()->route('admin.profile.index')->with('success','Password berhasil diedit!');
    }
    ...
    public function update_profile(Request $request)
    {
        ...
        if($request->all()){
            ...
            return redirect()->route('admin.profile.index')->with('success','Profile berhasil diedit!');
        }
    }
    ...
    public function update_avatar(Request $request)
    {
        if($request->file('avatar')){
            ...
            return redirect()->route('admin.profile.index')->with('success','Avatar berhasil diedit!');
        }else{
            return redirect()->route('admin.profile.index')->with('error','Avatar gagal diedit!');
        }
    }
}
