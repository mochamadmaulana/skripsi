...
namespace App\Http\Controllers\KepalaSekolah\ArsipSurat;
...
class SuratKeluarController extends Controller
{
    ...
    {
        $surat_keluar = true;
        return view('kepala-sekolah.arsip-surat.surat-keluar.index',compact('surat_keluar'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('kepala-sekolah.arsip-surat.surat-keluar.show',compact('surat_keluar'));
    }
}
