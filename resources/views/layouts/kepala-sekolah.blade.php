            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <!-- Surat Masuk -->
                        <li class="nav-item">
                            <a href="{{ route('kepala-sekolah.surat-masuk.index') }}" class="nav-link {{ (request()->is('kepala-sekolah/surat-masuk*')) ? 'active' : '' }}">
                        ...
                        <!-- Surat Keluar -->
                        <li class="nav-item">
                            <a href="{{ route('kepala-sekolah.surat-keluar.index') }}" class="nav-link {{ (request()->is('kepala-sekolah/surat-keluar*')) ? 'active' : '' }}">
                        ...
                        <!-- Arsip Surat -->
                        <li class="nav-item {{ request()->is('kepala-sekolah/arsip-surat*') ? 'menu-open' : '' }}">
                            <a href="#" class="nav-link {{ (request()->is('kepala-sekolah/arsip-surat*')) ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('kepala-sekolah.arsip-surat.surat-masuk.index') }}" class="nav-link {{ (request()->is('kepala-sekolah/arsip-surat/surat-masuk*')) ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Surat Masuk</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('kepala-sekolah.arsip-surat.surat-keluar.index') }}" class="nav-link {{ (request()->is('kepala-sekolah/arsip-surat/surat-keluar*')) ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Surat Keluar</p>
                                    </a>
                                </li>
                        ...
                        <!-- Laporan Surat -->
                        <li class="nav-item {{ request()->is('kepala-sekolah/laporan-surat*') ? 'menu-open' : '' }}">
                            <a href="#" class="nav-link {{ (request()->is('kepala-sekolah/laporan-surat*')) ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('kepala-sekolah.laporan-surat.surat-masuk.index') }}" class="nav-link {{ (request()->is('kepala-sekolah/laporan-surat/surat-masuk*')) ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Surat Masuk</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('kepala-sekolah.laporan-surat.surat-keluar.index') }}" class="nav-link {{ (request()->is('kepala-sekolah/laporan-surat/surat-keluar*')) ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Surat Keluar</p>
                                    </a>
                                </li>
