            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <!-- Surat Masuk -->
                        <li class="nav-item">
                            <a href="{{ route('user.surat-masuk.index') }}" class="nav-link {{ (request()->is('user/surat-masuk*')) ? 'active' : '' }}">
                        ...
                        <!-- Surat Keluar -->
                        <li class="nav-item">
                            <a href="{{ route('user.surat-keluar.index') }}" class="nav-link {{ (request()->is('user/surat-keluar*')) ? 'active' : '' }}">
