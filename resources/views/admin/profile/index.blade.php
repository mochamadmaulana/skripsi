@extends('layouts.admin', ['title' => 'Profile','icon' => 'fas fa-user'])
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="active tab-pane" id="tab-profile">
                    <form class="form-horizontal" action="{{ route('admin.profile.update-profile') }}" method="POST">
                        @csrf
                        @method('PUT')
                ...
                <div class="tab-pane" id="tab-avatar">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.profile.update-avatar') }}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
