<div class="row">
    <div class="col-lg-10 offset-lg-1">
        <form action="{{ route('admin.arsip-surat.surat-masuk.search') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-lg-6">
            ...
            <a href="{{ route('admin.arsip-surat.surat-masuk.index') }}" class="btn btn-sm btn-secondary"><i class="fas fa-sync mr-1"></i> Refresh</a>
        </form>
    </div>
</div>
