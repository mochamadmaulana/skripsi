@extends('layouts.kepala-sekolah', ['title' => 'Laporan Surat Keluar', 'icon' => 'fas fa-book'])

@section('content')
<div class="row">
    <div class="col-lg-10 offset-lg-1">
        <form action="{{ route('kepala-sekolah.laporan-surat.surat-keluar.export-excel') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-lg-6">
