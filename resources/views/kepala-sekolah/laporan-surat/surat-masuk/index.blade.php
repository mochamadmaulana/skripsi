@extends('layouts.kepala-sekolah', ['title' => 'Laporan Surat Masuk', 'icon' => 'fas fa-book'])

@section('content')
<div class="row">
    <div class="col-lg-10 offset-lg-1">
        <form action="{{ route('kepala-sekolah.laporan-surat.surat-masuk.export-excel') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <select name="pilih_tanggal" class="form-control @error('pilih_tanggal') is-invalid @enderror">
                            ...
                            <option value="Tanggal Diterima"  @if (@old('pilih_tanggal') == 'Tanggal Diterima') selected @endif>Tanggal Diterima</option>
                        </select>
