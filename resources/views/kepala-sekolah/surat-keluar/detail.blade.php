@extends('layouts.kepala-sekolah', ['title' => 'Detail Surat Keluar', 'icon' => 'fas fa-envelope'])
...
<div class="card">
    <div class="card-header">
      <h3 class="card-title">
        <a href="{{ route('kepala-sekolah.surat-keluar.index') }}" class="btn btn-sm btn-secondary shadow-sm">
...
@push('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('kepala-sekolah.surat-keluar.index') }}">List Data</a></li>
