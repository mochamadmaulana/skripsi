...
@section('content')
@include('kepala-sekolah.arsip-surat.surat-masuk.form')
...
@push('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('kepala-sekolah.arsip-surat.surat-masuk.index') }}">Form Search</a></li>
