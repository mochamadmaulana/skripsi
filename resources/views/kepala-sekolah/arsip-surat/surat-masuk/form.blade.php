<div class="row">
    <div class="col-lg-10 offset-lg-1">
        <form action="{{ route('kepala-sekolah.arsip-surat.surat-masuk.search') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <select name="pilih_tanggal" class="form-control @error('pilih_tanggal') is-invalid @enderror">
                            ...
                            <option value="Tanggal Diterima" @if(request()->get('pilih_tanggal') == 'Tanggal Diterima') selected @endif>Tanggal Diterima</option>
                        </select>
            ...
            <a href="{{ route('kepala-sekolah.arsip-surat.surat-masuk.index') }}" class="btn btn-sm btn-secondary"><i class="fas fa-sync mr-1"></i> Refresh</a>
        </form>
    </div>
</div>
