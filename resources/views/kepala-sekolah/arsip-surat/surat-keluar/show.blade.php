...
@section('content')
@include('kepala-sekolah.arsip-surat.surat-keluar.form')
...
@push('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('kepala-sekolah.arsip-surat.surat-keluar.index') }}">Form Search</a></li>
