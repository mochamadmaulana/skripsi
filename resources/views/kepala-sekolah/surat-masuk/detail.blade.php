@extends('layouts.kepala-sekolah', ['title' => 'Detail Surat Masuk', 'icon' => 'fas fa-envelope-open-text'])
...
<div class="card">
    <div class="card-header">
      <h3 class="card-title">
        <a href="{{ route('kepala-sekolah.surat-masuk.index') }}" class="btn btn-sm btn-secondary shadow-sm">
    ...
    <div class="card-body">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <p class="text-muted">
                    @foreach($surat_masuk->akses_surat_masuk as $as)
...
@push('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('kepala-sekolah.surat-masuk.index') }}">List Data</a></li>
