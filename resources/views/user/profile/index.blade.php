@extends('layouts.user', ['title' => 'Profile','icon' => 'fas fa-user'])
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="active tab-pane" id="tab-profile">
                    <form class="form-horizontal" action="{{ route('user.profile.update-profile') }}" method="POST">
                        @csrf
                        @method('PUT')
                ...
                <div class="tab-pane" id="tab-avatar">
                    <form class="form-horizontal" method="POST" action="{{ route('user.profile.update-avatar') }}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
