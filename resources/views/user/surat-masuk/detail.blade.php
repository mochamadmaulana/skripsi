@extends('layouts.user', ['title' => 'Detail Surat Masuk', 'icon' => 'fas fa-envelope-open-text'])
...
<div class="card">
    <div class="card-header">
      <h3 class="card-title">
        <a href="{{ route('user.surat-masuk.index') }}" class="btn btn-sm btn-secondary shadow-sm">
...
@push('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('user.surat-masuk.index') }}">List Data</a></li>
